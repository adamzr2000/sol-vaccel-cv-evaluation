...
class sol_swin_s:
    ...
    def init(self):
        ...
        self._session.exec_with_resource(
            resource,
            "sol_swin_s_init_unpack",
        )

    def free(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_swin_s_free_unpack",
        )

    def sync(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_swin_s_sync_unpack",
        )
