...
# is read from ros2/plot_config.py's SEG_REMOTE_CPU_TAG_OVERRIDE /
# SEG_REMOTE_GPU_TAG_OVERRIDE (e.g. a 12fps-capped rerun) - this script
# inherits whatever's configured there automatically. The ros2 energy plots
# (ros2/barplot_energy_consumption.py, ros2/barplot_energy_per_frame.py)
# read that exact same config, since energy and FPS/latency come from the
# same underlying benchmark run and must stay in sync.
