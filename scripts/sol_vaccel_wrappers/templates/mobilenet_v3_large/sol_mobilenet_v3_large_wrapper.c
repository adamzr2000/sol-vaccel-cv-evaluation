#include "sol_mobilenet_v3_large.h"
#include <assert.h>
#include <fcntl.h>
#include <stdio.h>
#include <stdint.h>
...
int sol_mobilenet_v3_large_init_unpack(struct vaccel_arg *read, size_t nr_read,
...
int sol_mobilenet_v3_large_set_IO_unpack(struct vaccel_arg *read, size_t nr_read,
				struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_mobilenet_v3_large_set_IO(in__input_0, out__0, vdims);
...
int sol_mobilenet_v3_large_run_unpack(struct vaccel_arg *read, size_t nr_read,
			     struct vaccel_arg *write, size_t nr_write)
{
...
int sol_mobilenet_v3_large_optimize_unpack(struct vaccel_arg *read, size_t nr_read,
				  struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_mobilenet_v3_large_optimize(level);
...
int sol_mobilenet_v3_large_sync_unpack(struct vaccel_arg *read, size_t nr_read,
			      struct vaccel_arg *write, size_t nr_write)
{
...
int sol_mobilenet_v3_large_get_output_unpack(struct vaccel_arg *read, size_t nr_read,
				    struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_mobilenet_v3_large_get_output();
...
int sol_mobilenet_v3_large_free_unpack(struct vaccel_arg *read, size_t nr_read,
			      struct vaccel_arg *write, size_t nr_write)
{
...
int sol_mobilenet_v3_large_free_host_unpack(struct vaccel_arg *read, size_t nr_read,
				   struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_mobilenet_v3_large_free_host();
...
int sol_mobilenet_v3_large_free_device_unpack(struct vaccel_arg *read, size_t nr_read,
				     struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_mobilenet_v3_large_free_device();
...
int sol_mobilenet_v3_large_set_seed_unpack(struct vaccel_arg *read, size_t nr_read,
				  struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_mobilenet_v3_large_set_seed(seed);
