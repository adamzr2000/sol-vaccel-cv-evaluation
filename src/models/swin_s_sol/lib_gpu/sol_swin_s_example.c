...
int main(int argc, char** argv) {
	...
	sol_swin_s_init(); // optional, reads parameters and moves them to device if necessary
	sol_swin_s_set_seed(314159); // optional
	...
	sol_swin_s_free(); // frees allocated parameters by lib
