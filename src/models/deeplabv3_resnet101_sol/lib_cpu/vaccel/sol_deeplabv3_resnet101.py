...
class sol_deeplabv3_resnet101:
    ...
    def init(self):
        ...
        self._session.exec_with_resource(
            resource,
            "sol_deeplabv3_resnet101_init_unpack",
        )

    def free(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_deeplabv3_resnet101_free_unpack",
        )

    def sync(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_deeplabv3_resnet101_sync_unpack",
        )
    ...
    def set_seed(self, seed):
        self._session.exec_with_resource(
            self._resource,
            "sol_deeplabv3_resnet101_set_seed_unpack",
    ...
    def optimize(self, level):
        self._session.exec_with_resource(
            self._resource,
            "sol_deeplabv3_resnet101_optimize_unpack",
    ...
    # matching C wrapper (sol_deeplabv3_resnet101_wrapper.c) now keeps aux
    ...
    def set_IO(self, args):
        ...
        with self.profiler("exec"):
            self._session.exec_with_resource(
                self._resource,
                "sol_deeplabv3_resnet101_set_IO_unpack",
                in_args,
            )
    ...
    def run(self, in__x=None, out__0_out=None, vdims=None):
        ...
        self._session.exec_with_resource(
            self._resource,
            "sol_deeplabv3_resnet101_run_unpack",
        )
        return None
    ...
    def get_output(self):
        ...
        if out_out_resource is not None:
            with self.profiler("exec"):
                self._session.exec_with_resource(
                    self._resource,
                    "sol_deeplabv3_resnet101_get_output_unpack",
                )
