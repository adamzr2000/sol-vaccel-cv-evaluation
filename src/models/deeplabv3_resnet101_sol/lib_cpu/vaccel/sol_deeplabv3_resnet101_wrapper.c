#include "sol_deeplabv3_resnet101.h"
#include <assert.h>
#include <fcntl.h>
#include <stdio.h>
#include <stdint.h>
...
int sol_deeplabv3_resnet101_init_unpack(struct vaccel_arg *read, size_t nr_read,
...
int sol_deeplabv3_resnet101_set_IO_unpack(struct vaccel_arg *read, size_t nr_read,
				struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_deeplabv3_resnet101_set_IO(in__x, out__0_out, out__0_aux, vdims);
...
int sol_deeplabv3_resnet101_run_unpack(struct vaccel_arg *read, size_t nr_read,
			     struct vaccel_arg *write, size_t nr_write)
{
...
int sol_deeplabv3_resnet101_optimize_unpack(struct vaccel_arg *read, size_t nr_read,
				  struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_deeplabv3_resnet101_optimize(level);
...
int sol_deeplabv3_resnet101_sync_unpack(struct vaccel_arg *read, size_t nr_read,
			      struct vaccel_arg *write, size_t nr_write)
{
...
int sol_deeplabv3_resnet101_get_output_unpack(struct vaccel_arg *read, size_t nr_read,
				    struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_deeplabv3_resnet101_get_output();
...
int sol_deeplabv3_resnet101_free_unpack(struct vaccel_arg *read, size_t nr_read,
			      struct vaccel_arg *write, size_t nr_write)
{
...
int sol_deeplabv3_resnet101_free_host_unpack(struct vaccel_arg *read, size_t nr_read,
				   struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_deeplabv3_resnet101_free_host();
...
int sol_deeplabv3_resnet101_free_device_unpack(struct vaccel_arg *read, size_t nr_read,
				     struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_deeplabv3_resnet101_free_device();
...
int sol_deeplabv3_resnet101_set_seed_unpack(struct vaccel_arg *read, size_t nr_read,
				  struct vaccel_arg *write, size_t nr_write)
{
	...
	sol_deeplabv3_resnet101_set_seed(seed);
