...
class sol_deeplabv3_resnet50:
    ...
    def init(self):
        ...
        self._session.exec_with_resource(
            resource,
            "sol_deeplabv3_resnet50_init_unpack",
        )

    def free(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_deeplabv3_resnet50_free_unpack",
        )

    def sync(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_deeplabv3_resnet50_sync_unpack",
        )
    ...
    def set_seed(self, seed):
        self._session.exec_with_resource(
            self._resource,
            "sol_deeplabv3_resnet50_set_seed_unpack",
    ...
    def optimize(self, level):
        self._session.exec_with_resource(
            self._resource,
            "sol_deeplabv3_resnet50_optimize_unpack",
    ...
    def set_IO(self, args):
        ...
        with self.profiler("exec"):
            self._session.exec_with_resource(
                self._resource,
                "sol_deeplabv3_resnet50_set_IO_unpack",
                in_args,
            )
    ...
    def run(self, in__x=None, out__0_out=None, out__0_aux=None, vdims=None):
        ...
        self._session.exec_with_resource(
            self._resource,
            "sol_deeplabv3_resnet50_run_unpack",
        )
        return None
    ...
    def get_output(self):
        ...
        if out_out_resource is not None and out_aux_resource is not None:
            with self.profiler("exec"):
                self._session.exec_with_resource(
                    self._resource,
                    "sol_deeplabv3_resnet50_get_output_unpack",
                )
