...
int main(int argc, char** argv) {
	...
	sol_f32 *_input_0 = (sol_f32*) malloc(1ll * 3ll * 16ll * 112ll * 112ll *  sizeof(sol_f32));
	
	// Define and Initialize Outputs---------------------------------------------
	sol_f32 *_0 = (sol_f32*) malloc(1ll * 400ll *  sizeof(sol_f32));
	
	// Generate Random Input----------------------------------------------------
	srand(0);
	for(size_t n = 0; n < 1ll * 3ll * 16ll * 112ll * 112ll * 1; n++)
		_input_0[n] = rand()/(sol_f32)RAND_MAX;
	
	for(size_t n = 0; n < 1ll * 400ll * 1; n++)
		_0[n] = 0;
	
	// Call generated library---------------------------------------------
	sol_swin3d_s_init(); // optional, reads parameters and moves them to device if necessary
	sol_swin3d_s_set_seed(314159); // optional
	...
	// Output #0
	data_per_batch = (1ll * 400ll * 1)/1ll;
	for(int i = 0; i < 1ll; i++){
		max_index = -1;
	...
	sol_swin3d_s_free(); // frees allocated parameters by lib
