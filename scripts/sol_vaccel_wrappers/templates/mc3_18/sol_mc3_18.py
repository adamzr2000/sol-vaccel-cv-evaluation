...
class sol_mc3_18:
    ...
    def init(self):
        ...
        self._session.exec_with_resource(
            resource,
            "sol_mc3_18_init_unpack",
        )

    def free(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_mc3_18_free_unpack",
        )

    def sync(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_mc3_18_sync_unpack",
        )
