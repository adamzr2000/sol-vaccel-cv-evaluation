...
def plot_combined(rows):
    ...
    fig, axes = plt.subplots(
        ...
        figsize=FIG_SIZE,
        sharey=False,
        gridspec_kw={"width_ratios": widths, "wspace": 0.05, "hspace": 0.08},
    )
    ...
    # Updated label to match your exact request
    hatch_handles = [
        mpatches.Patch(facecolor='white', edgecolor='black', hatch='', label='Inference'),
        mpatches.Patch(facecolor='white', edgecolor='black', hatch='////', label='Network + vAccel remoting layer'),
