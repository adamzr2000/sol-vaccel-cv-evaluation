...
int main(int argc, char** argv) {
	...
	sol_resnet50_init(); // optional, reads parameters and moves them to device if necessary
	sol_resnet50_set_seed(314159); // optional
	...
	sol_resnet50_free(); // frees allocated parameters by lib
