...
int main(int argc, char** argv) {
	...
	sol_swin3d_t_init(); // optional, reads parameters and moves them to device if necessary
	sol_swin3d_t_set_seed(314159); // optional
	...
	sol_swin3d_t_free(); // frees allocated parameters by lib
