...
class sol_swin_t:
    ...
    def init(self):
        ...
        self._session.exec_with_resource(
            resource,
            "sol_swin_t_init_unpack",
        )

    def free(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_swin_t_free_unpack",
        )

    def sync(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_swin_t_sync_unpack",
        )
