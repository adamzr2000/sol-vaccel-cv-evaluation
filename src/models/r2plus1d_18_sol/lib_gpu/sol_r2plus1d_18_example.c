...
int main(int argc, char** argv) {
	...
	sol_r2plus1d_18_init(); // optional, reads parameters and moves them to device if necessary
	sol_r2plus1d_18_set_seed(314159); // optional
	...
	sol_r2plus1d_18_free(); // frees allocated parameters by lib
