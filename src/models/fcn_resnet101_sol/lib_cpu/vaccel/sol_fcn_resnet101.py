...
class sol_fcn_resnet101:
    ...
    def init(self):
        ...
        self._session.exec_with_resource(
            resource,
            "sol_fcn_resnet101_init_unpack",
        )

    def free(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_fcn_resnet101_free_unpack",
        )

    def sync(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_fcn_resnet101_sync_unpack",
        )
    ...
    def set_seed(self, seed):
        self._session.exec_with_resource(
            self._resource,
            "sol_fcn_resnet101_set_seed_unpack",
    ...
    def optimize(self, level):
        self._session.exec_with_resource(
            self._resource,
            "sol_fcn_resnet101_optimize_unpack",
    ...
    # matching C wrapper (sol_fcn_resnet101_wrapper.c) now keeps aux
    ...
    def set_IO(self, args):
        ...
        with self.profiler("exec"):
            self._session.exec_with_resource(
                self._resource,
                "sol_fcn_resnet101_set_IO_unpack",
                in_args,
            )
    ...
    def get_output(self):
        ...
        if out_out_resource is not None:
            with self.profiler("exec"):
                self._session.exec_with_resource(
                    self._resource,
                    "sol_fcn_resnet101_get_output_unpack",
                )
