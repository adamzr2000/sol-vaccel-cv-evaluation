...
def generate_summary():
    ...
    # Find all CSV files in the current directory with "idle" in the name
    # (not just ending in "-idle.csv" - e.g. "robot-cpu-idle-ros.csv" for a
    # ROS-node-running-but-no-inference baseline)
