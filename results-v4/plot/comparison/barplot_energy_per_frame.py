...
# ros2_epf transitively reads SEG_REMOTE_GPU_TAG_OVERRIDE from
# ros2/barplot_e2e_latency_and_fps.py (its own _e2e_mod alias) -- this
# script inherits whatever's set there automatically. ROS2 only, Remote
# GPU only, applied uniformly to every semantic-segmentation model. Set it
# on ros2_epf directly for a run limited to this script:
#
# ros2_epf.SEG_REMOTE_GPU_TAG_OVERRIDE = "remote-gpu12fps"
