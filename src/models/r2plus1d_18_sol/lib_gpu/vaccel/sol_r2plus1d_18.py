...
class sol_r2plus1d_18:
    ...
    def init(self):
        ...
        self._session.exec_with_resource(
            resource,
            "sol_r2plus1d_18_init_unpack",
        )

    def free(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_r2plus1d_18_free_unpack",
        )

    def sync(self):
        self._session.exec_with_resource(
            self._resource,
            "sol_r2plus1d_18_sync_unpack",
        )
    ...
    def set_seed(self, seed):
        self._session.exec_with_resource(
            self._resource,
            "sol_r2plus1d_18_set_seed_unpack",
    ...
    def optimize(self, level):
        self._session.exec_with_resource(
            self._resource,
            "sol_r2plus1d_18_optimize_unpack",
    ...
    def get_output(self):
        ...
        if out_resource is not None:
            with self.profiler("exec"):
                self._session.exec_with_resource(
                    self._resource,
                    "sol_r2plus1d_18_get_output_unpack",
                )
