...
int main(int argc, char** argv) {
	...
	sol_mc3_18_init(); // optional, reads parameters and moves them to device if necessary
	sol_mc3_18_set_seed(314159); // optional
	...
	sol_mc3_18_free(); // frees allocated parameters by lib
